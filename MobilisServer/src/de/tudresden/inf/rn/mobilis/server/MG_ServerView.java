 ...
 */
public class MG_ServerView extends FrameView implements MobilisView {
	...
	public MG_ServerView(SingleFrameApplication app) {
		super(app);
	...
	private void initComponents() {
		...
		javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(de.tudresden.inf.rn.mobilis.server.MG_Server.class).getContext().getActionMap(MG_ServerView.class, this);
		btnConnect.setAction(actionMap.get("login")); // NOI18N
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(de.tudresden.inf.rn.mobilis.server.MG_Server.class).getContext().getResourceMap(MG_ServerView.class);
