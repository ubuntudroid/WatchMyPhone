...
import org.jivesoftware.smackx.provider.AffiliationProvider;
import org.jivesoftware.smackx.provider.AffiliationsProvider;
import org.jivesoftware.smackx.provider.ConfigEventProvider;
import org.jivesoftware.smackx.provider.DelayInfoProvider;
import org.jivesoftware.smackx.provider.EventProvider;
import org.jivesoftware.smackx.provider.HeaderProvider;
import org.jivesoftware.smackx.provider.HeadersProvider;
import org.jivesoftware.smackx.provider.ItemProvider;
import org.jivesoftware.smackx.provider.ItemsProvider;
import org.jivesoftware.smackx.provider.PubSubProvider;
import org.jivesoftware.smackx.provider.RetractEventProvider;
import org.jivesoftware.smackx.provider.SimpleNodeProvider;
import org.jivesoftware.smackx.provider.SubscriptionProvider;
import org.jivesoftware.smackx.provider.SubscriptionsProvider;
...
public class PubSubService extends Service {
	...
	private class ReaderThread extends Thread implements PacketListener {
		...
		public void processPacket(Packet packet) {
			...
			List<Item> items = (List<Item>) ie.getItems();
			for (Item i : items) {
				buf.append(i.toXML());
			}
