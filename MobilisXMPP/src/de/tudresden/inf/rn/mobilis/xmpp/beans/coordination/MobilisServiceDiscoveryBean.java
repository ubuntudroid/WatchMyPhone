...
public class MobilisServiceDiscoveryBean extends XMPPBean {
	...
	public String serviceNamespace, serviceVersion;
	...
	public MobilisServiceDiscoveryBean(String serviceNamespace, String serviceVersion) {
		super();
	...
	public MobilisServiceDiscoveryBean clone() {
		MobilisServiceDiscoveryBean twin = new MobilisServiceDiscoveryBean(serviceNamespace, serviceVersion);		
		...
		do {
			...
			case XmlPullParser.START_TAG:
				...
				if (tagName.equals(childElement)) {
					...
					this.serviceVersion = parser.nextText();	
