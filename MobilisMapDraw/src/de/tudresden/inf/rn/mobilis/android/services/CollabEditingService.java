...
import de.tudresden.inf.rn.mobilis.android.util.Parceller;
import de.tudresden.inf.rn.mobilis.mapdraw.DocumentFactory;
import de.tudresden.inf.rn.mobilis.mapdraw.Monitoring;
...
//        Parceller.getInstance().registerXMPPBean(beanPrototype3);		
	...
	public void connectToMXA() {		
        mxaController.connectMXA(SessionService.getInstance().getContext(), mxaConnectionListener);        
	}
...
//		Bundle connectionParams = XMPPController.getInstance().readXMPPPreferences();
		...
		XMPPController.getInstance().registerPacketListener();
...
//		da.Element_AttributeSet(...);		
    ...
    public void makeToast(String text) {
    	Toast.makeText(SessionService.getInstance().getContext(), text, Toast.LENGTH_SHORT).show();
    }
